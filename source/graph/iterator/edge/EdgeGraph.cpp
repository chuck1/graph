...
typedef gr::iterator::edge::EdgeGraph THIS;

THIS::EdgeGraph(gr::container::vert & container, THIS::iterator0 const & i):
...
THIS::EdgeGraph(gr::container::vert & container, THIS::iterator0 const & i, THIS::iterator1 const & j):
	_M_container(container),
	_M_i(i),
	_M_j(j)
{
